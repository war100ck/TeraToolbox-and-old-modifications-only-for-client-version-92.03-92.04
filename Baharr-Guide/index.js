...
const Baharr = {
		...
		120: {msg: '←左侧安全← (坦右移)'},
		121: {msg: '左脚出→(4连半月)'},
		122: {msg: '左脚出→(4连半月) 第3波加速'},
		123: {msg: '左脚出→(4连半月) 第2波加速'},
		125: {msg: '前砸 -> 后拉'},//125 126 127
		131: {msg: '大大前砸 -> 后拉'},//131 132 134
		135: {msg: '||完美格挡||'},
		137: {msg: '后砸'},		
		138: {msg: '救人 -> 击飞'},//113 138		
		139: {msg: '旋转(全屏击倒)'}, //108 110 139    118 139    101 105 107 139
		140: {msg: '右脚出→(4连半月)'},
		141: {msg: '右脚出→(4连半月) 第3波加速'},
		142: {msg: '右脚出→(4连半月) 第2波加速'},
	//	305: {msg: '滚石 (秒杀)1'},
	//	306: {msg: '滚石 (秒杀)2'},
	...
	function sActionStage(event) {
		...
		switch (skillid) {
			...
			case 125:	// 右前砸+后拉
				...
				SpawnCircle(itemID1, 3000,  10, 350);
				break;
				
			case 131:	// 左前砸+后拉
				SpawnThing(   false,  100, 182, 340);
				SpawnCircle(itemID1, 3000,  10, 660);
				break;	
			case 111:	// 后砸 (慢慢慢慢)
				SpawnThing(   false,  100, 0, 500);
				SpawnCircle(itemID1, 3000, 10, 480);
				break;
			case 137:	// 后砸
				SpawnThing(   false,  100, 0, 500);
				SpawnCircle(itemID1, 3000, 10, 480);
